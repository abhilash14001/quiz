...
if (isset($postdata ['key'])) {
	...
	if ($status == 'success'  && $resphash == $CalcHashString) {
		 ...
		 mysqli_query($con, "update quiz set payment = 'success', userid = '$userid' where payment = 'Not Done'");
		 mysqli_query($con, "update user set wallet = wallet+'$amount' where id = '$userid'");
