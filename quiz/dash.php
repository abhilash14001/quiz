...
<div class="form-group">
  <label class="col-md-12 control-label" for="time"></label>  
  <div class="col-md-12">
  <input id="start_time" name="start_time" placeholder="Enter start time with format DD-MM-YYYY h:m:s ex: 30-01-2020 6:42:00pm" class="form-control input-md" type="text">
