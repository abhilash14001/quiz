...
$name    = $_POST['name'];
$_SESSION['title'] = $name    = ucwords(strtolower($name));
$_SESSION['total'] =  $total   = $_POST['total'];
$_SESSION['correct']=  $correct = $_POST['right'];
$_SESSION['wrong'] = $wrong   = $_POST['wrong'];
$_SESSION['time'] = $time    = $_POST['time'];
$_SESSION['start_time'] = $start_time = $_POST['start_time'];
$_SESSION['desc'] = $desc = $_POST['desc'];
$_SESSION['prize'] =	$prize = $_POST['prize'];
$status  = "disabled";
$_SESSION['qid'] = $id      = uniqid();
$q3  = mysqli_query($con, "INSERT INTO quiz VALUES(NULL,'$id','$name','$correct','$wrong','$total','$time', NOW(), '$start_time', '$prize', '$desc', '$status', 'Pending')");
