...
<div class="main">
    ...
    <input type="hidden" id="key" name="key" placeholder="Merchant Key" value="<?php echo $keye; ?>" />
    
    
      
    <input type="hidden" id="salt" name="salt" placeholder="Merchant Salt" value="<?php echo $salte; ?>" />
    
    
     <div class="dv">
    <input type="hidden" id="txnid" name="txnid" placeholder="Transaction ID" value="<?php echo $titi=  "Txn" . rand(10000,99999999)?>" />
    <label>Transaction ID: &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <?php echo $titi; ?></label>
    </div>
    <div class="dv">
    ...
    <div class="dv">
    <span class="text"><label>Purpose of Payment:</label></span>
    <span><input type="text" id="pinfo" name="pinfo" placeholder="Purpose of payment" value="" /></span>
    </div>
