...
<link rel="stylesheet" href="bower_components/eonasdan-bootstrap-datetimepicker/build/css/bootstrap-datetimepicker.min.css" /><link href='https://fonts.googleapis.com/css?family=Roboto:400,700,300' rel='stylesheet' type='text/css'> 
...
if (@$_GET['q'] == 6)
echo 'class="active"';
?>><a href="dash.php?q=6">Money Requested</a></li>
...
$eid     = $row['eid'];
$status  = $row['status'];
if ($status == "enabled" || $status == "samplequiz") {
echo '<tr><td style="vertical-align:middle">' . $c++ . '</td><td style="vertical-align:middle">' . $title . '</td><td style="vertical-align:middle">' . $total . '</td><td style="vertical-align:middle">' . $correct * $total . '</td><td style="vertical-align:middle">' . $time . '&nbsp;secs</td><td style="vertical-align:middle">Enabled</td>';
if(!($status == "samplequiz"))
{
echo '<td style="vertical-align:middle"><b><a href="update.php?deidquiz=' . $eid . '" class="btn logb" style="color:#FFFFFF;background:#ff0000;font-size:12px;padding:5px;">&nbsp;<span><b>Disable</b></span></a></b></td></tr>';
}
else{
echo '<td style="vertical-align:middle"><b><button class = "btn btn-primary btn btn-sm">Sample quiz</b></button></td></tr>';	
}
}  else {
echo '<tr><td style="vertical-align:middle">' . $c++ . '</td><td style="vertical-align:middle">' . $title . '</td><td style="vertical-align:middle">' . $total . '</td><td style="vertical-align:middle">' . $correct * $total . '</td><td style="vertical-align:middle">' . $time . '&nbsp;secs</td><td style="vertical-align:middle">Disabled</td>
...
<tr><td style="vertical-align:middle"><b>Rank</b></td><td style="vertical-align:middle"><b>Name</b></td><td style="vertical-align:middle"><b>Email</b></td><td style="vertical-align:middle"><b>Username</b></td><td style="vertical-align:middle"><b>Gender</b></td><td style="vertical-align:middle"><b>Score</b></td></tr>';
$c = $showfrom-1;
...
$c++;
echo '<tr><td style="color:#99cc32"><b>' . $c . '</b></td><td style="vertical-align:middle">' . $name . '</td><td style="vertical-align:middle">' . $email . '</td><td style="vertical-align:middle">' . $username . '</td><td style="vertical-align:middle">' . $gender . '</td><td style="vertical-align:middle">' . $s . '</td><td style="vertical-align:middle">';
}
}
else{
}
...
echo '<tr><td style="vertical-align:middle">' . $c++ . '</td><td style="vertical-align:middle">' . $name . '</td><td style="vertical-align:middle">' . $gender . '</td><td style="vertical-align:middle">' . $email . '</td><td style="vertical-align:middle">' . $username1 . '</td><td style="vertical-align:middle">' . $phno . '</td>
...
<form class="form-horizontal title1" enctype = "multipart/form-data" name="form" action="update.php?q=addquiz"  method="POST">
<fieldset>
...
<div class="col-md-12">
<input name="time" placeholder="Enter time limit for test in seconds" class="form-control input-md" min="5" type="number">

</div>
</div>
<div class="form-group">
<label class="col-md-12 control-label" for="entr"></label>  
<div class="col-md-12">
<input id="entry_fee" name="entry" placeholder="Enter entry fee for the quiz" class="form-control input-md" type="text">
...
<label class="col-md-12 control-label" for="time"></label>  
<div class="col-md-12">
<input id="datetimepicker" name="start_time" placeholder="Enter start time with format DD-MM-YYYY h:m:s ex: 30-01-2020 6:42:00pm" class="form-control input-md" type="text">
...
<label class="col-md-12 control-label" for="time"></label>  
<div class="col-md-12">
<input id="description" name="desc" placeholder="Enter quiz description" class="form-control input-md" type="text">
...
<label class="col-md-12 control-label" for="time"></label>  
<div class="col-md-12">
<input id="description" name="tobereg" placeholder="Enter No. of users to be registered" class="form-control input-md" type="text">
...
<label class="col-md-12 control-label" for="time"></label>  
<div class="col-md-12">
<input id="prize" name="prize" placeholder="Enter Prize money" class="form-control input-md" type="number">
...
<label class="col-md-12 control-label" for="time"></label>  
<div class="col-md-12">
<input name="quizphoto" class="form-control input-md" type="file">
...
$time    = $row['time'];
$eid     = $row['eid'];
echo '<tr><td style="vertical-align:middle">' . $c++ . '</td><td style="vertical-align:middle">' . $title . '</td><td style="vertical-align:middle">' . $total . '</td><td style="vertical-align:middle">' . $correct * $total . '</td><td style="vertical-align:middle">' . $time . '&nbsp;secs</td>
